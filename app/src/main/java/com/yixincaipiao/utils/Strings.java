...
/**
 * 类名：StringUtils.java<br />
 * 版本：<br />
 * 描述：字符串处理工具类<br />
 * 创建者：zhengxu<br />
 * 创建时间：2011-3-15<br />
 * 修改者：[修改者1]｜[修改者2]｜...｜[修改者n]<br />
 * 修改时间：[修改时间1]｜[修改时间2]｜...｜[修改时间n]<br />
 * 修改描述1：<br />
 * 修改描述2：<br />
 * 修改描述n：<br />
 */
public class Strings {
    ...
    /**
     * 将字符串数据转变成SQL 中IN的语句，如 [a,b,c]->'a','b','c'
     * 
     * @param array
     * @return
     */
    ...
    /**
     * 将逗号分隔的字符串SQL 中IN的语句，如 a,b,c->'a','b','c'
     * 
     * @param srcStr
     * @return
     */
    public static String stringToDBStr(String srcStr) {
        String[] tempAttr = Strings.stringToArray(srcStr, ',', true);
     ...
     * @return long 返回由数字字符串转化成的数字，当srcStr为空或空字符串时，则返回缺省值defaultValue
     */
    public static float getFloat(String srcStr, float defaultValue) {
        if (isEmpty(srcStr))
            return defaultValue;
     ...
     * @return long 返回由数字字符串转化成的数字，当srcStr为空或空字符串时，则返回0。
     */
    public static float getFloat(String srcStr) {
        return getFloat(srcStr, 0);
    }
     ...
     * @return
     */
    public static String DecodeUTF8(String sutf8) {
        if (isNotEmpty(sutf8)) {
            try {
                return URLDecoder.decode(sutf8, "UTF-8");
            } catch (Exception e) {
                e.printStackTrace();
                return "";
            }
    ...
    public static String substring(String str, int toCount, String more) {
        ...
        int i = 0;
        for (i = 0; i < tempChar.length && toCount > reInt; i++) {
