...
public class StreamFileUpload extends AsyncTask<Object, Object, Object> {
    ...
    public StreamFileUpload(String url, Map<String, Object> params, Map<String, InputStream> files,
            UploadListener listener) {
        this.mUrl = url;
        this.params = params;
        this.files = files;
        ...
        try {
            ...
            if (files != null)
                ...
                for (String key : files.keySet()) {
                    InputStream valuefile = files.get(key);
                    ...
                    publishProgress(1, valuefile.hashCode());
                    ...
                    publishProgress(3, valuefile.hashCode());
                }
            // 请求结束标志
    ...
    protected void onProgressUpdate(Object... values) {
        ...
        if (listener != null) {
            ...
            switch (state) {
                ...
                case 2 :
                    // 上传进度
                    // listener.onUpFileProgress(values[1].toString(),
                    // Strings.getFloat(values[2].toString()));
                    // break;
                case 3 :
