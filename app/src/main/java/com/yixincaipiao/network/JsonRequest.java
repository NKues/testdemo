...
/**
 * 类名：JsonRequest.java<br>
 * 描述： 自定义请求Request类(保存请求的所有参数)<br>
 * 创建者： jack<br>
 * 创建日期：2014-11-20<br>
 * 版本： <br>
 * 修改者： <br>
...
public class JsonRequest extends Request<String> {
    ...
    public void setTimeout(int time) {
        if (time == 25000)
            return;// volley默认25秒
        RetryPolicy retryPolicy = new DefaultRetryPolicy(time, DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
     ...
     * @param method
     * @param url
     * @param listener 正确时的回调
     * @param errorListener 错误时的回调
     */
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        if (headers == null) {
            ...
            // cookie = addtime6=1233; addtime82=1233; addtime43=1233;
            // addtime90=1233
            // content-type = application/x-www-form-urlencoded; charset=utf-8
            // user-agent = Dalvik/1.6.0 (Linux; U; Android 4.1.2; LG-F160K
            // Build/JZO54K)
            // host = 192.168.191.1:8080
            // connection = Keep-Alive
        }

        // （cookie提交方式）cookie = LoginCookie=f5e2ff194d3f6bfad0ffeca33c90b81b;
        // JSESSIONID=E2157841B595D0AE93D1C6F0DE6DD1F8
